...
class RequestsApi {
  ...
  static fetchRequests({required String token}) async {
    ...
    try {
      debugPrint('gettting requests.... ${Uri.parse(baseUrl)}');
  ...
  static Future<dynamic> getSentRequests(
    ...
    try {
      ...
      debugPrint("Error fetching alerts from ID $worksAt: $e");
      return null;
    }
  }
  ...
  static Future<dynamic> getReceivedRequests(
    ...
    try {
      ...
      debugPrint("Error fetching alerts to ID $worksAt: $e");
      return null;
    }
  }
  ...
  static Future<bool> createRequest({
    ...
    try {
      ...
      debugPrint('Request creation response: $responseData');
  ...
  static Future<int> getUnreadReceivedRequestsCount({
    ...
    try {
      ...
      debugPrint('Error fetching unread received requests count: $e');
      return 0;
    }
  }
}
